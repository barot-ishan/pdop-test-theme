                    ...
                    <div class="accordion-item">
                        ...
                        ?>
                            <h2 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq_collapse_<?php echo $i; ?>" aria-expanded="false" aria-controls="collapse<?php echo $i; ?>">
                        ...
                        <div id="faq_collapse_<?php echo $i; ?>" class="accordion-collapse collapse" data-bs-parent="#program_faq_accordion">
