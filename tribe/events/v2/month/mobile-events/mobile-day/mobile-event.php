<?php
/**
 * Custom Mobile Event Card for Month View
 */

defined( 'ABSPATH' ) || exit;
$event_id = $event->ID;

// Keep TEC default classes
$classes = tribe_get_post_class(['tribe-events-calendar-month__mobile-event', 'pdop-event-card'], $event_id);
...
<article <?php tec_classes($classes); ?> class="<?php echo esc_attr($card_class); ?>">
    ...
    <div class="pdop-event-card-inner">
        ...
        <div class="event-title tribe-events-calendar-month__mobile-event-title">
        ...
        <div class="event-action">
            ...
            <?php else: ?>
                ...
                <a href="<?php echo esc_url(get_permalink($event_id)); ?>" class="register">
                    Register
                </a>
            <?php endif; ?>
        </div>
