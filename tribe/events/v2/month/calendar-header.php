...
<thead class="tribe-events-calendar-month__header">
	<tr>
		...
		foreach (tribe_events_get_days_of_week() as $day):
			...
			?>
			<th class="tribe-events-calendar-month__header-column" scope="col" abbr="<?php echo esc_attr($day_abbrev); ?>">

				<div class="tribe-events-calendar-month__header-column-title tribe-common-b3">
					<span aria-hidden="true" class="tribe-events-header-day--desktop">
							<?php echo esc_html($day_abbrev); ?>
					</span>
					<span aria-hidden="true" class="tribe-events-header-day--mobile">
